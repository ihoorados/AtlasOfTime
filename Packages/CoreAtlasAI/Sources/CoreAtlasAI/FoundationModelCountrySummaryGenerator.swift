...
public struct FoundationModelCountrySummaryGenerator: CountrySummaryGenerating, Sendable {
    ...
    public init(
        ...
        self.init(
            model: model,
            promptBuilder: CountrySummaryPromptBuilder()
        )
    }
    ...
    public func generateSummary(for request: CountrySummaryRequest) async throws -> CountrySummaryResult {
