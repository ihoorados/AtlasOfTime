...
public protocol BorderSnapshotLoading: Sendable {
    func loadSnapshot(year: Int, relativePath: String) async throws -> YearSnapshot
}

public struct DefaultBorderSnapshotLoader: BorderSnapshotLoading {
    ...
    public func loadSnapshot(year: Int, relativePath: String) async throws -> YearSnapshot {
